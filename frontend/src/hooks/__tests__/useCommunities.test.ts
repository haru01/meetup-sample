...
describe('useCommunities フック', () => {
  ...
  it('fetchCommunities でコミュニティ一覧を取得する', async () => {
    const communities = [
      { id: '1', name: 'Test Community', description: 'desc', category: 'TECH', visibility: 'PUBLIC', createdAt: '', updatedAt: '' },
    ]
  ...
  it('getCommunity で単一コミュニティを取得する', async () => {
    const community = { id: '1', name: 'Test', description: 'desc', category: 'TECH', visibility: 'PUBLIC', createdAt: '', updatedAt: '' }
  ...
  it('createCommunity でコミュニティを作成する', async () => {
    const community = { id: '1', name: 'New', description: 'desc', category: 'TECH', visibility: 'PUBLIC', createdAt: '', updatedAt: '' }
  ...
  it('getMyCommunities でマイコミュニティを取得する', async () => {
    const communities = [
      { id: '1', name: 'My Community', description: 'desc', category: 'BUSINESS', visibility: 'PRIVATE', createdAt: '', updatedAt: '' },
    ]
    mockGet.mockResolvedValue({ ok: true, data: { communities } })
