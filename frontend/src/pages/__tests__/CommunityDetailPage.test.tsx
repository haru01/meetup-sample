...
vi.mock('../../hooks/useMembers', () => ({
  useMembers: () => ({
    members: [
      { id: 'm1', communityId: 'c1', accountId: 'owner1', role: 'OWNER', status: 'ACTIVE', createdAt: '' },
      { id: 'm2', communityId: 'c1', accountId: 'user1', role: 'MEMBER', status: 'ACTIVE', createdAt: '' },
    ],
    loading: false,
    error: null,
...
describe('CommunityDetailPage', () => {
    ...
    render(
      <AuthContext.Provider
        value={createAuthContext({
          user: { id: 'owner1', email: 'owner@test.com', name: 'Owner', createdAt: '' },
  ...
  it('未参加ユーザーには参加ボタンが表示される', () => {
    render(
      <AuthContext.Provider
        value={createAuthContext({
          user: { id: 'newuser', email: 'new@test.com', name: 'New', createdAt: '' },
          isAuthenticated: true,
        })}
      >
        <MemoryRouter>
