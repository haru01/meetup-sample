...
const mockCommunities = [
  { id: '1', name: 'Tech Community', description: 'Tech desc', category: 'TECH' as const, visibility: 'PUBLIC' as const, createdAt: '', updatedAt: '' },
  { id: '2', name: 'Art Community', description: 'Art desc', category: 'HOBBY' as const, visibility: 'PRIVATE' as const, createdAt: '', updatedAt: '' },
]
...
describe('CommunityListPage', () => {
  ...
  it('見出しが表示される', () => {
    renderPage()
    expect(screen.getByRole('heading', { name: 'コミュニティ一覧' })).toBeInTheDocument()
  })
})
