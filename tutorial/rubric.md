...
| **Day 2** | 午前 | 3, 7 | **レビューする** | diff を読む、テストで検証、計画の抜け漏れを指摘、失敗パターンを体験。**軸 5 振り返り**: 「自分は今何を理解し、何が曖昧か」を確認 | L2→L3: diff を確認し、問題を指摘・軌道修正できる |
| **Day 2** | 午後 | 4 | **安定化する** | CLAUDE.md にルール追加、hooks 設定、過剰な CLAUDE.md の弊害を体験 | L2→L3: 設定ファイルでルールを永続化できる |
| **Day 3** | 午前 | 6 | **使い分ける** | 伴奏 vs 委託の実践、サブエージェント活用、/clear によるコンテキスト管理。**軸 5 振り返り**: 学習障害サインのセルフチェック | L2→L3: 場面に応じて伴奏と委託を選択できる |
